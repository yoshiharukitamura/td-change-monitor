    ...
    from
      ...
      left join (
          select distinct
            ...
            , therapy_date
          from
            l1_datamart_202210.prep_sys_reservation_logs_with_therapy_date
      ...
      left join l1_datamart_202210.prep_sys_reservation_logs_with_therapy_date as t4 on t1.reservation_id = t4.reservation_id
