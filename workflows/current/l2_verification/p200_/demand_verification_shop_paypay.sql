with shop_list as (
  ...
  from
    ${td.database}.list_demand_paypay_v2
...
, prep_orders as (
  ...
  where
    not td_time_parse(business_date, 'jst') between td_time_parse('2025-06-16', 'jst') and td_time_parse('2025-06-22', 'jst')
    -- and not td_time_parse(business_date, 'jst') between td_time_parse('2025-06-23', 'jst') and td_time_parse('2025-06-29', 'jst')
    and not td_time_parse(business_date, 'jst') between td_time_parse('2025-07-10', 'jst') and td_time_parse('2025-07-10', 'jst')
  group by
    1,2,3
)
, cls_sufficiency as (
