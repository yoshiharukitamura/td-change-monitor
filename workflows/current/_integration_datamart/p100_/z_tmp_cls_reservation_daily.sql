...
select distinct
  td_date_trunc('day', t0.created_unixtime, 'jst') as time
  , td_time_string(td_date_trunc('day', t0.created_unixtime, 'jst'), 'd!', 'jst') as day
  , t0.created_unixtime
  , t0.reservation_id
  , t0.start_unixtime
  ...
  , case
      ...
      when td_date_trunc('day', t0.created_unixtime, 'jst') <= td_date_trunc('day', coalesce(t2.first_order_unixtime, td_scheduled_time()), 'jst') then '新規'
      when td_date_trunc('day', t0.created_unixtime, 'jst') > td_date_trunc('day', coalesce(t2.first_order_unixtime, td_scheduled_time()), 'jst') then '既存'
    end as new_repeat
